...
nodep = 34
AND 
(titre = 'Représentant' OR titre = 'Secrétaire');
...
SELECT
nom, 
LOCATE('r',nom) AS `rang de la lettre "r"`
FROM
employe
WHERE 
nom LIKE '%r%';
...
SELECT
nom,
LENGTH(nom) AS `nombre de cracatères dans le nom`
FROM
employe;
