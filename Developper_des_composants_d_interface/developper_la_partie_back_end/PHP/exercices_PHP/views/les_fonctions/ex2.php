                ...
                <div class="card indigo lighten-2 center-align col s12">
                    <div class="card-content white-text">
                        <span class="card-title">
                            <p class="flow-text">Écrivez une fonction qui calcule la somme des valeurs d'un tableau.</p>
                        </span>
                        <p class="flow-text">La fonction doit prendre un paramètre de type tableau.</p>
                    </div>
                </div>
