                ...
                <div class="card-panel indigo lighten-2 center-align col s12">
                    <div class="card-content white-text">
                        <span class="card-title">
                            <p class="flow-text">Écrire un programme qui écrit 500 fois la phrase : Je dois faire des sauvegardes régulières de mes fichiers.</h1>
                            </p>
                        </span>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="card-panel indigo lighten-3">
                    <div class="card-content white-text">
                        <pre><code>$x = 1;
do {
    echo "$x - Je dois faire des sauvegardes r&eacute;guli&egrave;res de mes fichiers.&lt;br&gt;";
    $x++;
} while ($x &lt;= 500);</code></pre>
                    </div>
                </div>
            </div>
