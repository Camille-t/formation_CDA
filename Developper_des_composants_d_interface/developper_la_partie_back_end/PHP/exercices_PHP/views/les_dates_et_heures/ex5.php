        ...
        <nav class="nav-extended indigo lighten-1">
            ...
            <div class="nav-content">
                <ul class="tabs tabs-transparent">
                    ...
                    <li class="tab"><a class="active" href="ex5.php">exercice 5</a></li>
        ...
        <div class="container">
                        ...
                        <div class="card indigo lighten-2 center-align col s12">
                                <div class="card-content white-text">
                                        <span class="card-title">
                                                <p class="flow-text">Affichez l'heure courante sous cette forme : 11h25.</p>
                                        </span>
                                </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="card-panel indigo lighten-3 col s12">
                                <div class="card-content white-text">
                                        <pre><code>$heureCourante = new DateTime();
        echo $heureCourante-&gt;format("H\hi");</code></pre>
                                </div>
                        </div>
                        ...
                        <div class="card indigo lighten-3 center-align col s12">
                                <div class="card-content white-text">
                                        <p class="flow-text">
                                                ...
                                                echo $heureCourante->format("H\hi");
                                                ?>
                                        </p>
                                </div>
                        </div>
