        ...
        <nav class="nav-extended indigo lighten-1">
            ...
            <div class="nav-content">
                <ul class="tabs tabs-transparent">
                    ...
                    <li class="tab"><a class="active" href="ex6.php">exercice 6</a></li>
        ...
        <div class="container">
                        ...
                        <div class="card indigo lighten-2 center-align col s12">
                                <div class="card-content white-text">
                                        <span class="card-title">
                                                <p class="flow-text">Ajoutez un mois à la date courante.</p>
                                        </span>
                                </div>
                        </div>
                ...
                <div class="row">
                        ...
                        <div class="card-panel indigo lighten-3 col s12">
                                <div class="card-content white-text">
                                        <pre><code>$dateCourante = new DateTime();
$interval = new DateInterval("P1M");
$dateCourante-&gt;add($interval);
echo $dateCourante-&gt;format("d/m/Y");</code></pre>
                                </div>
                        </div>
